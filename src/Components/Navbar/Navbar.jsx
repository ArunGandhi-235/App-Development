...
// This function will show an Elevation effect on the Navbar when scrolling
...
const Links = ({ drawer, setIsOpenDrawer, isOpenDrawer }) => {
    ...
    const pageLink = [new LinkClass(0, 'Home'), new LinkClass(1, 'Admin'), new LinkClass(2, 'Categories')];
...
const Navbar = (props) => {
    ...
    const [userRole, setUserRole] = React.useState(null); // State to hold the user's role

    React.useEffect(() => {
        // Simulate fetching the user's role
        // In a real application, you would fetch this from your backend or context
        if (isUserLoggedIn) {
            // Set userRole based on the logged-in user
            // This is just a placeholder. Replace with actual role fetching logic
                                ...
                                <div className='flex w-full justify-between items-center'>
                                    ...
                                    <div className='flex items-center space-x-8'>
                                        ...
                                        <div className='sm:space-x-8 space-x-5'>
                                            ...
                                            {/* Conditionally render User and Admin buttons */}
                                            {isUserLoggedIn ? (
                                                <>
                                                    {userRole === 'admin' && (
                                                        <Button
